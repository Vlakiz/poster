...
ActiveRecord::Schema[8.0].define(version: 2025_08_07_080453) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string "first_name", limit: 70, default: "Unknown", null: false
  ...
  add_foreign_key "comments", "comments", column: "replied_to_id"
